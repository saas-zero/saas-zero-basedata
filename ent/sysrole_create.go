...
func (_c *SysRoleCreate) SetCreatedID(v int64) *SysRoleCreate {
...
func (_c *SysRoleCreate) SetUpdatedID(v int64) *SysRoleCreate {
...
func (_c *SysRoleCreate) SetDeletedID(v int64) *SysRoleCreate {
	_c.mutation.SetDeletedID(v)
	return _c
}

// SetNillableDeletedID sets the "deleted_id" field if the given value is not nil.
func (_c *SysRoleCreate) SetNillableDeletedID(v *int64) *SysRoleCreate {
	if v != nil {
		_c.SetDeletedID(*v)
	}
	return _c
...
func (_c *SysRoleCreate) SetStatus(v sysrole.Status) *SysRoleCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *SysRoleCreate) SetNillableStatus(v *sysrole.Status) *SysRoleCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *SysRoleCreate) SetSort(v uint32) *SysRoleCreate {
	_c.mutation.SetSort(v)
	return _c
}

// SetNillableSort sets the "sort" field if the given value is not nil.
func (_c *SysRoleCreate) SetNillableSort(v *uint32) *SysRoleCreate {
	if v != nil {
		_c.SetSort(*v)
	}
	return _c
...
func (_c *SysRoleCreate) AddMenuIDs(ids ...int64) *SysRoleCreate {
	_c.mutation.AddMenuIDs(ids...)
	return _c
}

// AddMenus adds the "menus" edges to the SysMenu entity.
func (_c *SysRoleCreate) AddMenus(v ...*SysMenu) *SysRoleCreate {
...
func (_c *SysRoleCreate) AddUsers(v ...*SysUser) *SysRoleCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *SysRoleCreate) check() error {
	...
	if _, ok := _c.mutation.CreatedID(); !ok {
		return &ValidationError{Name: "created_id", err: errors.New(`ent: missing required field "SysRole.created_id"`)}
	}
	if v, ok := _c.mutation.CreatedID(); ok {
		if err := sysrole.CreatedIDValidator(v); err != nil {
			return &ValidationError{Name: "created_id", err: fmt.Errorf(`ent: validator failed for field "SysRole.created_id": %w`, err)}
		}
	}
	...
	if _, ok := _c.mutation.UpdatedID(); !ok {
		return &ValidationError{Name: "updated_id", err: errors.New(`ent: missing required field "SysRole.updated_id"`)}
	}
...
func (_c *SysRoleCreate) createSpec() (*SysRole, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.CreatedID(); ok {
		_spec.SetField(sysrole.FieldCreatedID, field.TypeInt64, value)
