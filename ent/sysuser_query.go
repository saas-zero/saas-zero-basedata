...
func (_q *SysUserQuery) QueryRoles() *SysRoleQuery {
...
func (_q *SysUserQuery) WithRoles(opts ...func(*SysRoleQuery)) *SysUserQuery {
	query := (&SysRoleClient{config: _q.config}).Query()
...
func (_q *SysUserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SysUser, error) {
	...
	if query := _q.withRoles; query != nil {
		if err := _q.loadRoles(ctx, query, nodes,
			...
			func(n *SysUser, e *SysRole) { n.Edges.Roles = append(n.Edges.Roles, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SysUserQuery) loadRoles(ctx context.Context, query *SysRoleQuery, nodes []*SysUser, init func(*SysUser), assign func(*SysUser, *SysRole)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(sysuser.RolesTable)
		s.Join(joinT).On(s.C(sysrole.FieldID), joinT.C(sysuser.RolesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(sysuser.RolesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(sysuser.RolesPrimaryKey[0]))
