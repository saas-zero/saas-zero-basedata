...
func (l *DeleteDictDataLogic) DeleteDictData(req *types.IdsReq) (*types.BaseResp, error) {
	resp, err := l.svcCtx.SysDictDatas.DeleteDictData(l.ctx, &apps.IdsReq{Ids: parseIds(req.Ids)})
	if err != nil {
		return nil, err
	}
