...
const file_basedata_service_proto_rawDesc = "" +
	...
	"\tadminName\x18\x13 \x01(\tH\x12R\tadminName\x88\x01\x01B\x05\n" +
	"\x03_idB\b\n" +
	"\x06_idStrB\a\n" +
	"\x05_nameB\a\n" +
	"\x05_codeB\n" +
	...
	"\x11AssignPackageApis\x12\x1c.basedata_service.PackageReq\x1a\x1b.basedata_service.EmptyResp2\xde\x02\n" +
	"\aSysApis\x12@\n" +
...
var file_basedata_service_proto_depIdxs = []int32{
	...
	57, // 86: basedata_service.SysLogs.GetLoginLogList:input_type -> basedata_service.LogPageReq
	57, // 87: basedata_service.SysLogs.GetOperationLogList:input_type -> basedata_service.LogPageReq
	54, // 88: basedata_service.SysLogs.CreateOperationLog:input_type -> basedata_service.OperationLog
	55, // 89: basedata_service.SysInit.InitAll:input_type -> basedata_service.EmptyReq
	10, // 90: basedata_service.SysUsers.CreateUser:output_type -> basedata_service.UserResp
	10, // 91: basedata_service.SysUsers.UpdateUser:output_type -> basedata_service.UserResp
	56, // 92: basedata_service.SysUsers.DeleteUser:output_type -> basedata_service.EmptyResp
	9,  // 93: basedata_service.SysUsers.GetUserList:output_type -> basedata_service.UserListResp
	10, // 94: basedata_service.SysUsers.GetUserById:output_type -> basedata_service.UserResp
	10, // 95: basedata_service.SysUsers.GetUserByUsername:output_type -> basedata_service.UserResp
	56, // 96: basedata_service.SysUsers.ResetPassword:output_type -> basedata_service.EmptyResp
	56, // 97: basedata_service.SysUsers.AssignRoles:output_type -> basedata_service.EmptyResp
	60, // 98: basedata_service.SysUsers.GetUserRoleCodes:output_type -> basedata_service.RoleCodesResp
	56, // 99: basedata_service.SysUsers.RecordLoginResult:output_type -> basedata_service.EmptyResp
	15, // 100: basedata_service.SysRoles.CreateRole:output_type -> basedata_service.RoleResp
	15, // 101: basedata_service.SysRoles.UpdateRole:output_type -> basedata_service.RoleResp
	56, // 102: basedata_service.SysRoles.DeleteRole:output_type -> basedata_service.EmptyResp
	14, // 103: basedata_service.SysRoles.GetRoleList:output_type -> basedata_service.RoleListResp
	15, // 104: basedata_service.SysRoles.GetRoleById:output_type -> basedata_service.RoleResp
	56, // 105: basedata_service.SysRoles.AssignMenus:output_type -> basedata_service.EmptyResp
	56, // 106: basedata_service.SysRoles.AssignApis:output_type -> basedata_service.EmptyResp
	21, // 107: basedata_service.SysDepts.CreateDept:output_type -> basedata_service.DeptResp
	21, // 108: basedata_service.SysDepts.UpdateDept:output_type -> basedata_service.DeptResp
	56, // 109: basedata_service.SysDepts.DeleteDept:output_type -> basedata_service.EmptyResp
	19, // 110: basedata_service.SysDepts.GetDeptList:output_type -> basedata_service.DeptListResp
	21, // 111: basedata_service.SysDepts.GetDeptById:output_type -> basedata_service.DeptResp
	20, // 112: basedata_service.SysDepts.GetDeptTree:output_type -> basedata_service.DeptTreeResp
	27, // 113: basedata_service.SysMenus.CreateMenu:output_type -> basedata_service.MenuResp
	27, // 114: basedata_service.SysMenus.UpdateMenu:output_type -> basedata_service.MenuResp
	56, // 115: basedata_service.SysMenus.DeleteMenu:output_type -> basedata_service.EmptyResp
	25, // 116: basedata_service.SysMenus.GetMenuList:output_type -> basedata_service.MenuListResp
	27, // 117: basedata_service.SysMenus.GetMenuById:output_type -> basedata_service.MenuResp
	26, // 118: basedata_service.SysMenus.GetMenuTree:output_type -> basedata_service.MenuTreeResp
	26, // 119: basedata_service.SysMenus.GetMenuRouters:output_type -> basedata_service.MenuTreeResp
	33, // 120: basedata_service.SysDicts.CreateDict:output_type -> basedata_service.DictResp
	33, // 121: basedata_service.SysDicts.UpdateDict:output_type -> basedata_service.DictResp
	56, // 122: basedata_service.SysDicts.DeleteDict:output_type -> basedata_service.EmptyResp
	32, // 123: basedata_service.SysDicts.GetDictList:output_type -> basedata_service.DictListResp
	33, // 124: basedata_service.SysDicts.GetDictById:output_type -> basedata_service.DictResp
	37, // 125: basedata_service.SysDictDatas.CreateDictData:output_type -> basedata_service.DictDataResp
	37, // 126: basedata_service.SysDictDatas.UpdateDictData:output_type -> basedata_service.DictDataResp
	56, // 127: basedata_service.SysDictDatas.DeleteDictData:output_type -> basedata_service.EmptyResp
	36, // 128: basedata_service.SysDictDatas.GetDictDataList:output_type -> basedata_service.DictDataListResp
	37, // 129: basedata_service.SysDictDatas.GetDictDataById:output_type -> basedata_service.DictDataResp
	36, // 130: basedata_service.SysDictDatas.GetDictDataByDictKey:output_type -> basedata_service.DictDataListResp
	42, // 131: basedata_service.SysTenants.CreateTenant:output_type -> basedata_service.TenantResp
	42, // 132: basedata_service.SysTenants.UpdateTenant:output_type -> basedata_service.TenantResp
	56, // 133: basedata_service.SysTenants.DeleteTenant:output_type -> basedata_service.EmptyResp
	41, // 134: basedata_service.SysTenants.GetTenantList:output_type -> basedata_service.TenantListResp
	42, // 135: basedata_service.SysTenants.GetTenantById:output_type -> basedata_service.TenantResp
	42, // 136: basedata_service.SysTenants.GetTenantByCode:output_type -> basedata_service.TenantResp
	56, // 137: basedata_service.SysTenants.ChangeTenantStatus:output_type -> basedata_service.EmptyResp
	9,  // 138: basedata_service.SysTenants.GetTenantUsers:output_type -> basedata_service.UserListResp
	47, // 139: basedata_service.SysPackages.CreatePackage:output_type -> basedata_service.PackageResp
	47, // 140: basedata_service.SysPackages.UpdatePackage:output_type -> basedata_service.PackageResp
	56, // 141: basedata_service.SysPackages.DeletePackage:output_type -> basedata_service.EmptyResp
	46, // 142: basedata_service.SysPackages.GetPackageList:output_type -> basedata_service.PackageListResp
	47, // 143: basedata_service.SysPackages.GetPackageById:output_type -> basedata_service.PackageResp
	56, // 144: basedata_service.SysPackages.AssignPackageMenus:output_type -> basedata_service.EmptyResp
	56, // 145: basedata_service.SysPackages.AssignPackageApis:output_type -> basedata_service.EmptyResp
	52, // 146: basedata_service.SysApis.CreateApi:output_type -> basedata_service.ApiResp
	52, // 147: basedata_service.SysApis.UpdateApi:output_type -> basedata_service.ApiResp
	56, // 148: basedata_service.SysApis.DeleteApi:output_type -> basedata_service.EmptyResp
	51, // 149: basedata_service.SysApis.GetApiList:output_type -> basedata_service.ApiListResp
	52, // 150: basedata_service.SysApis.GetApiById:output_type -> basedata_service.ApiResp
	58, // 151: basedata_service.SysLogs.GetLoginLogList:output_type -> basedata_service.LoginLogListResp
	59, // 152: basedata_service.SysLogs.GetOperationLogList:output_type -> basedata_service.OperationLogListResp
	56, // 153: basedata_service.SysLogs.CreateOperationLog:output_type -> basedata_service.EmptyResp
	56, // 154: basedata_service.SysInit.InitAll:output_type -> basedata_service.EmptyResp
